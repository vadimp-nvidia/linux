...
#define MLXPLAT_CPLD_PSU_SMART_SWITCH_NR	6
...
#define MLXPLAT_CPLD_NR_DPU_BASE		17
...
static int mlxplat_mlxcpld_smart_switch_pwr_nr_fixup[] = {
	MLXPLAT_CPLD_PSU_SMART_SWITCH_NR,
	MLXPLAT_CPLD_PSU_SMART_SWITCH_NR,
	MLXPLAT_CPLD_PSU_SMART_SWITCH_NR,
	MLXPLAT_CPLD_PSU_SMART_SWITCH_NR,
	MLXPLAT_CPLD_PSU_SMART_SWITCH_NR,
...
static int __init mlxplat_dmi_smart_switch_matched(const struct dmi_system_id *dmi)
{
	...
	for (i = 0; i < ARRAY_SIZE(mlxplat_mlxcpld_xdr_pwr_items_data); i++)
			mlxplat_mlxcpld_xdr_pwr_items_data[i].hpdev.nr =
			mlxplat_mlxcpld_smart_switch_pwr_nr_fixup[i];
	mlxplat_max_adap_num = MLXPLAT_CPLD_MAX_PHYS_ADAPTER_NUM;
	mlxplat_mux_num = ARRAY_SIZE(mlxplat_ng800_mux_data);
	mlxplat_mux_data = mlxplat_ng800_mux_data;
