...
static const struct resource nvsw_host_lpc_resources[] = {
...
{
	nvsw_host_dev = platform_device_register_simple("nvswplat", -1,
							nvsw_host_lpc_resources,
							ARRAY_SIZE(nvsw_host_lpc_resources));
